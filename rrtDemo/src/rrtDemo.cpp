...
VisRRT::VisRRT()
    : rrt_(new RRT(
        pose_t(-5.0, -5.0, 0.0, 0.0), // range_a
        pose_t(5.0, 5.0, 10.0, 0.0),  // range_b
        pose_t(0.0, 0.0, 0.0, 0.7854), // origin
        pose_t(5.0, 5.0, 10.0, 0.0),  // dest
        0.8, 1.0, 0.5, 2.0, // constraints
        10.0, // max_time
        true, // dim_3D
        10000, // node_limit
        1,     // max_admissible
        3.0,   // max_long_accel (default)
        1.0,   // max_long_jerk (default)
        1.0    // max_kappa_rad (default)
    ))
{}

VisRRT::VisRRT(std::vector<std::pair<pose_t, double>> _occupancy_map,
    ...
    : rrt_(new RRT(_occupancy_map,
        ...
        _max_long_accel, _max_long_jerk, _max_kappa_rad))
{
}
...
{
    std::vector<std::pair<pose_t, double>> occupancy_map;
    for (size_t i = 0; i < _occp_coords.size(); ++i) {
        std::pair<pose_t, double> occ;
...
PYBIND11_MODULE(rrtDemo, m) {
    ...
    py::class_<VisRRT>(m, "RRT")
        .def(py::init<>()) // Default
        .def(py::init<std::vector<std::pair<pose_t, double>>, pose_t, pose_t, pose_t, pose_t, double, double, double, double, double, bool, int, int, double, double, double>(),
             py::arg("occupancy_map"), py::arg("range_a"), py::arg("range_b"), py::arg("origin"), py::arg("dest"),
             py::arg("max_angle_rad"), py::arg("max_dist"), py::arg("min_dist"), py::arg("max_interval"),
             py::arg("max_time"), py::arg("dim_3D"), py::arg("iteration_limit"), py::arg("max_admissible"),
             py::arg("max_long_accel"), py::arg("max_long_jerk"), py::arg("max_kappa_rad"))
        .def(py::init<pose_t, pose_t, pose_t, pose_t, double, double, double, double, double, bool, int, int, double, double, double>(),
             py::arg("range_a"), py::arg("range_b"), py::arg("origin"), py::arg("dest"),
             py::arg("max_angle_rad"), py::arg("max_dist"), py::arg("min_dist"), py::arg("max_interval"),
             py::arg("max_time"), py::arg("dim_3D"), py::arg("iteration_limit"), py::arg("max_admissible"),
             py::arg("max_long_accel"), py::arg("max_long_jerk"), py::arg("max_kappa_rad"))
